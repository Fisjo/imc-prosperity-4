...
#   4. trade_david_option EMA alpha=0.0003 is ~3000-tick half-life.
...
#
#   Options (trade_david, smile_sleeve): unchanged — they already
...
class Trader:
    ...
    # ── Options: trade_david (unchanged from v19) ─────────────────
